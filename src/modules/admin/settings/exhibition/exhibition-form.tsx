                ...
                <div className="grid gap-4 lg:gap-8">
                  <div className="grid auto-rows-max items-start gap-4 lg:gap-8">
                    <Card x-chunk="dashboard-07-chunk-0">
                      <CardHeader>
                        <CardTitle>Exhibition Detail</CardTitle>
                        <CardDescription>
                          Basic details you might include when adding a exhition type such as
                          events, exhibition and other information.
                        </CardDescription>
                      </CardHeader>
                      <CardContent>
                        <div className="grid gap-6">
                          <div className="grid gap-3">
                            <FormField
                              ...
                              render={({ field }) => (
                                <FormItem>
                                  <FormLabel>Exhibition Type <span className="text-red-600">*</span></FormLabel>
                                  <FormControl>
